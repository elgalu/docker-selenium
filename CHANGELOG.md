...
## 3.11.0-p3
 + **Changes:** https://github.com/elgalu/docker-selenium/compare/3.11.0-p2...3.11.0-p3 (2018-03-14)
    + Leo Gallucci (1):
 ...
 + **Image tag details:**
    ...
    + Built at CI  host with: Docker version 17.09.0, build afdb6d4
    + Built at CI  host with: Docker Compose version 1.17.1, build 6d101fb
    + Image version: 3.11.0-235
    + Image size: 1.38GB
    + Digest: sha256:d97d1e9b59ded53b1afdd98959e80e1414ddd261a983a3079dcf039f88080868

## 3.11.0-p2
 + **Changes:** https://github.com/elgalu/docker-selenium/compare/3.11.0-p1...3.11.0-p2 (2018-03-14)
    + Leo Gallucci (1):
 ...
 + **Image tag details:**
    ...
    + Built at CI  host with: Docker version 17.09.0, build afdb6d4
    + Built at CI  host with: Docker Compose version 1.17.1, build 6d101fb
    + Image version: 3.11.0-234
    + Image size: 1.38GB
    + Digest: sha256:5368a22da2507556e3b870ebc82ab23078a63987be913618750f3b814e54750f
...
## 3.0.1-p3
 + **Changes:** (2017-01-03)
    + Upgrade Chromedriver minor from 2.26 to 2.27
 + **Image tag details:**
    + Selenium 2: 2.53.1 (a36b8b1)
    + Selenium 3: 3.0.1 (1969d75)
    + Chrome stable:  55.0.2883.87
...
## 3.0.1-p2
 + **Changes:** (2016-12-22)
    + Upgrade Firefox minor from 50.0.2 to 50.1.0
    + Upgrade Ubuntu xenial date from 20161121 to 20161213
 + **Image tag details:**
    + Selenium 2: 2.53.1 (a36b8b1)
    + Selenium 3: 3.0.1 (1969d75)
    + Chrome stable:  55.0.2883.87
